  ...
  return (
    <GlowCard className={`flex flex-col h-full ${service.popular ? 'border-primary shadow-[0_0_30px_-10px_var(--primary)]' : 'border-primary/20'}`}>
      ...
      <div className="flex flex-col flex-1">
        ...
        <h3 className="text-2xl font-bold mb-2 text-foreground font-heading">{service.title}</h3>
        <p className="text-muted-foreground mb-6 text-sm leading-relaxed">{service.shortDescription}</p>
      ...
      {/* Bottom action container pinned via mt-auto */}
